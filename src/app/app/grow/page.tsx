...
/**
 * Ascend OS — Grow index. Elevated from a bare nav grid to the North Star's
    ...
    <div className="max-w-6xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-white/50">
          Where day-to-day execution lives — your leads, pipeline, and follow-up at a glance, then the tools to work them.
        </p>
      </div>
