    ...
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <article className="prose dark:prose-invert mt-8 max-w-none">
        ...
        <p>
          ...
          subscriber. This is a hosted SaaS service, not a software
        ...
        <p>
          ...
          operate (via our subprocessors. See our{" "}
...
, not DivineX, controls your access, role, and
        ...
        <p>
          ...
          non-payment alone. Access is paywalled, not your data
        ...
        <p>
          ...
          already paid for, and you will not be charged again, but
        ...
        <ul>
          ...
          <li>
            ...
            (STOP/START), {brand.name} provides opt-out handling and a
        ...
        <p>
          AI-generated content, including replies sent to your leads
          and customers, summaries, and suggested actions, may be
        ...
        <p>
          ...
          features, for example, payment processing, email and SMS
          ...
          PayPal.me username). In those cases, you are responsible
        ...
        <p>
          ...
          {brand.name} (&ldquo;Your Data&rdquo;), your contacts,
        ...
        <p>
          ...
          platform itself, its software, design, and underlying
